...
|-------|-----------------|---------|-----------|
| **Release version** | `.claude-plugin/plugin.json`, `.codex-plugin/plugin.json`, `.claude-plugin/marketplace.json` (must always agree) | `2.4.1` | Any user-visible change to skills, routing, docs, or packaging. |
