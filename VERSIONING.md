...
|-------|-----------------|---------|-----------|
| **Release version** | `VERSION`, `.claude-plugin/plugin.json`, `.codex-plugin/plugin.json`, `.claude-plugin/marketplace.json` (must always agree) | `4.2.0` | Any user-visible change to skills, routing, docs, or packaging. |
