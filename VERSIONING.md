...
|-------|-----------------|---------|-----------|
| **Release version** | `VERSION`, `.claude-plugin/plugin.json`, `.codex-plugin/plugin.json`, `.claude-plugin/marketplace.json` (must always agree) | `3.5.2` | Any user-visible change to skills, routing, docs, or packaging. |
